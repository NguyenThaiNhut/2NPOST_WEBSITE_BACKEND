...
module.exports = function (sequelize, DataTypes) {
  var Transportation = /*#__PURE__*/function (_Model) {
    _inherits(Transportation, _Model);
    var _super = _createSuper(Transportation);
    function Transportation() {
      _classCallCheck(this, Transportation);
      return _super.apply(this, arguments);
    }
    _createClass(Transportation, null, [{
      key: "associate",
      value:
      /**
      ...
      function associate(models) {
        this.belongsTo(models.Order, {
          //liên kết transportation với order
          foreignKey: 'idOrder',
